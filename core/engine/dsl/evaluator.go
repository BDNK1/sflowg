...
func (e *ExpressionEvaluator) Eval(execution *core.Execution, expression string) (any, error) {
	return risor.Eval(execution, expression, risor.WithEnv(convertGlobals(execution.Values())))
}

func (e *ExpressionEvaluator) EvalWithEnv(execution *core.Execution, expression string, extraVars map[string]any) (any, error) {
